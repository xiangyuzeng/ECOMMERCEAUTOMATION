...
See [INPUT_CHECKLIST.md](INPUT_CHECKLIST.md) for detailed export instructions.

**Required (10 file types):**

| Source | Files | Drop In |
|--------|-------|---------|
| SellerSprite | ExpandKeywords, KeywordMining, CompareKeywords, AdsInsights, Competitor, KeywordResearch (.xlsx) | `inputs/sellersprite/` |
| Seller Central | BusinessReport, SpSearchTerm, SpCampaign, FBAFee (.csv) | `inputs/seller-central/` |

The dashboard's "数据管理" tab also has a built-in acquisition guide.
